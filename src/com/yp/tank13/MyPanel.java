...
public class MyPanel extends JPanel implements KeyListener {
    ...
    public MyPanel(){
        ...
        for(int i=0;i<bsize;i++){
            Boss boss = new Boss(300+i*400,150,Direction.D);
            bosses.add(boss);
        }
        ...
        for(int i=0;i<lmsize;i++){
            LandMine landMine = new LandMine(100+i*300,300);
    ...
    public void paintComponent(Graphics g) {
        ...
        //帮助文档
        g.setFont(new Font("TankGame", Font.BOLD, 20));
        g.drawString("帮助文档:", 1110, 300);
        g.drawString("用→ ← ↑ ↓控制方向!", 1110, 330);
        g.drawString("空格键发射子弹!", 1110, 360);
        g.drawString("F1键发射导弹!", 1110, 390);
        g.drawString("普通坦克用子弹!", 1110, 420);
        g.drawString("Boss坦克用导弹!", 1110, 450);
            ...
            if(myTank.isLive){
                ...
                for(int j=0;j<myTank.bullets.size();j++){
                    ...
                    if(myBullet.isLive==true){
                        myBullet.drawEnBullet(myBullet.x,myBullet.y,g,myBullet.direction);
            ...
            if(boss.isLive){
                ...
                for (int j = 0; j < boss.bullets.size(); j++) {
                    ...
                    if (bossBullet.isLive) {
                        bossBullet.drawEnBullet(bossBullet.x, bossBullet.y,g,bossBullet.direction);
            ...
            if (et.isLive) {
                ...
                for (int j = 0; j < et.bullets.size(); j++) {
                    ...
                    if (enemyBullet.isLive) {
                        enemyBullet.drawEnBullet(enemyBullet.x, enemyBullet.y,g,enemyBullet.direction);
