...
public class Bomb {
    ...
    static{
        bombImage = new Image[]{
                tk.getImage(Shot.class.getResource("/images/bomb_1.png")),
                tk.getImage(Shot.class.getResource("/images/bomb_2.png")),
                tk.getImage(Shot.class.getResource("/images/bomb_3.png")),
                tk.getImage(Shot.class.getResource("/images/bomb_4.png")),
                tk.getImage(Shot.class.getResource("/images/bomb_5.png")),
        };
