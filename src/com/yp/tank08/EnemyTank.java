...
public class EnemyTank extends Tank implements Runnable{
    ...
    static{
        enemyTankImage = new Image[]{
                tk.getImage(Shot.class.getResource("/images/enemytank_U.png")),
                tk.getImage(Shot.class.getResource("/images/enemytank_D.png")),
                tk.getImage(Shot.class.getResource("/images/enemytank_L.png")),
                tk.getImage(Shot.class.getResource("/images/enemytank_R.png")),
        };
